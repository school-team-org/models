...
type UserModel struct {
	...
	VillageId      string    `json:"village_id" bson:"village_id" form:"village_id" valid:"required,oid"`
	...
	VillageBirthId string    `json:"village_birth_id" bson:"village_birth_id" form:"village_birth_id" valid:"required,oid"`
