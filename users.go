...
type UserModel struct {
	...
	BirthDate      string  `json:"birth_date" bson:"birth_date" form:"birth_date" validate:"required,datetime=2000-10-10"`
	...
	VillageId      string  `json:"village_id" bson:"village_id" form:"village_id" validate:"required,uuid"`
	...
	VillageBirthId string  `json:"village_birth_id" bson:"village_birth_id" form:"village_birth_id" validate:"required,uuid"`
