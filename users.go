...
type UserModel struct {
	...
	VillageId      ObjectID  `json:"village_id" bson:"village_id" form:"village_id" validate:"required"`
	...
	VillageBirthId ObjectID  `json:"village_birth_id" bson:"village_birth_id" form:"village_birth_id" validate:"required"`
